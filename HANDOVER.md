...
**Last updated:** 2026-07-20 evening (Session 34: **сим-марафон по вариантам/парам/пулам — bins 28 подтверждён в третий раз, новых пар-кандидатов нет; скилл simulator переписан, кэш пар переехал на `--symbol`**).
